...
class Works {
  constructor() {
    ...
    this.worksValues = [
      {
        id: "works-item-1",
        text: 'Это многостраничный сайт, выступающий минимум в двух ролях: онлайн-курс по созданию и продвижению видео и интернет-магазин видеоаппаратуры. В данный момент находится в разработке.',
        link: "https://github.com/ValeriaTorgonina/video-studio.pro",
        tags: ["html5", "css3", "jquery"],
      },
      {
        id: "works-item-2",
        text: 'Данный сайт является платформой по созданию онлайн-курсов. К сожалению, бесплатно просмотреть можно лишь верхушку айсберга: в админ-части реализовано море сложных и интересных идей, таких как: конструктор страниц акций, создание вебинаров и прочее.',
        link: "Нет",
        tags: ["html5", "css3", "jquery", "bootstrap"],
      },
      {
        id: "works-item-3",
        text: 'Доробатывала и улучшала функционал frontend-части интернет-магазина "Стройплатформа". В основном решала интерфейсные задачи.',
        link: "Нет",
        tags: ["html5", "css3", "jquery"],
      },
      {
        id: "works-item-4",
        text: 'Делали площадку для продажи различной одежду и аксессуаров "BlackSides", использовали базовые web-технологии, с использованием server-side rendering.',
        link: "Нет",
        tags: ["html5", "css3", "jquery"],
      },
      {
        id: "works-item-5",
        text: 'Выполняли работы для медицинского центра "КристаллМед". Сайт представляет собой CMS-систему с небольшим новостным блогом и прайс-листом услуг.',
        link: "Нет",
        tags: ["html5", "css3", "jquery"],
      },
      {
